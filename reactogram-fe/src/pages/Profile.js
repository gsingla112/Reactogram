...
const Profile = () => {
  ...
  const addPost = async ()=>{
    if(image.preview === ''){
      ...
      // write the api call to create post
    ...
    <div className="container shadow mt-3 p-4">
      <div className="row">
        <div className="col-md-6 d-flex flex-column">
          ...
          <p className="ms-3 fs-5">UI/UX Designer | Follow @{user.user.fullName}</p>
      ...
      <div className="row mb-4" >
          ...
          <div className="card" onClick={handleShow}>
            <img onClick={()=> showDetail(post)} style={{ cursor: "Pointer"}}
              src={post.image}
                ...
                <div id="carouselExampleIndicators" className="carousel slide">
                  ...
                  <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                      <img src="https://images.unsplash.com/photo-1467826839480-0c2a3783b327?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item">
                      <img src="https://images.unsplash.com/photo-1461300617643-0aeca186c805?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="d-block w-100" alt="..." />
                    </div>
                  </div>
                  <button
                ...
                <div className='row'>
                  ...
                  <div className='col-sm-12'>
                    <div className="form-floating mb-3">
                      <input onChange={(ev)=>setLocation(ev.target.value)} type="text" className="form-control" id="floatingInput" placeholder="Add Location" />
